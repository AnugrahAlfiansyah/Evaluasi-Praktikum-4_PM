package com.example.a1_prak1b_13120220025;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void bukaGalleryClick(View view) {
        ...
        if (permissionReadStorage != PackageManager.PERMISSION_GRANTED) {
            if (android.os.Build.VERSION.SDK_INT > 30)
                ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.READ_MEDIA_IMAGES}, REQ_CODE_PERM_STORAGE);
            else
                ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, REQ_CODE_PERM_STORAGE);
            return;
        }
        bukaGallery();
    }
